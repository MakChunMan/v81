...
var App = function() {
    ...
    var colorThemePreview = function() {
        ...
        if (themeLink.length) {
            themeColor = themeLink.attr('href').replace("/v81/","");
        }
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    themeLink.attr('href', '/v81/'+themeColor);
                } else {
                    $('link[href="/v81/css/themes.css"]')
                        .before('<link id="theme-link" rel="stylesheet" href="/v81/' + themeColor + '">');
